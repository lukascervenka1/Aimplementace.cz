        ...
        <section id="hero" className="hero-section" aria-label="Úvodní sekce">
            <div className="container hero-container">
                <div className="hero-content">
                    <p className="hero-eyebrow">Tvorba webových stránek na míru & AI automatizace · Praha a celá ČR</p>
                    <h1 className="hero-title">
                        Postavíme vám web,<br />
                        který <em className="hero-italic">prodává</em>
                    </h1>
                    <p className="hero-subtitle">
                        Profesionální tvorba webů v čistém kódu, bez WordPress a bez Wix.
